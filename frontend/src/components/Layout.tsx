    ...
    <div className="min-h-screen bg-transparent">
      ...
      <div className="lg:hidden sticky top-0 z-30 bg-white/90 backdrop-blur border-b border-slate-200/70">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            <BarChart3 className="h-6 w-6 text-sl-red" />
            <div>
          ...
          <div className="h-9 w-9 rounded-full bg-sl-red/10 flex items-center justify-center text-sm font-medium text-sl-red">
            {initials}
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="border-b border-slate-200/70">
          <div className="h-1 bg-sl-red" />
          <div className="flex items-center gap-2 px-6 py-4">
            <BarChart3 className="h-8 w-8 text-sl-red" />
              ...
              <div key={item.name} className="space-y-1">
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? 'bg-sl-red/10 text-sl-red border-sl-red'
        ...
        <div className="p-4 border-t border-slate-200 mt-auto">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-full bg-sl-red/10 flex items-center justify-center">
              <span className="text-sm font-medium text-sl-red">
